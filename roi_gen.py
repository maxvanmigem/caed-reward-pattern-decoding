...
lvs_roi = image.binarize_img('./roi/FUP_FUNDUS_OF_PUTAMEN_VENTRAL_STRIATUM_LEFT.nii.gz', threshold=0.1)
rvs_roi = image.binarize_img('./roi/FUP_FUNDUS_OF_PUTAMEN_VENTRAL_STRIATUM_RIGHT.nii.gz', threshold=0.1)
lmofc_roi = image.binarize_img('./roi/AREA_FO3_OFC_LEFT.nii.gz', threshold=0.1)
rmofc_roi = image.binarize_img('./roi/AREA_FO3_OFC_RIGHT.nii.gz', threshold=0.1)
...
nib.save(lvs_roi, './roi/clean_roi/lvs_roi.nii.gz')
nib.save(rvs_roi, './roi/clean_roi/rvs_roi.nii.gz')
nib.save(lmofc_roi, './roi/clean_roi/lmofc_roi.nii.gz')
nib.save(rmofc_roi, './roi/clean_roi/rmofc_roi.nii.gz')
nib.save(bi_vs_roi, './roi/clean_roi/bi_vs_roi.nii.gz')
nib.save(bi_mofc_roi, './roi/clean_roi/bi_mofc_roi.nii.gz')
nib.save(left_roi, './roi/clean_roi/left_roi.nii.gz')
nib.save(right_roi, './roi/clean_roi/right_roi.nii.gz')
nib.save(all_roi, './roi/clean_roi/all_roi.nii.gz')
